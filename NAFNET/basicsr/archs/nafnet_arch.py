    ...
    def __init__(self, c, DW_Expand=1, FFN_Expend=2, sca=False, sg=False):
        ...
        if sca is True:
            self.sca = nn.Sequential(
                ...
                nn.Conv2d(in_channels=dw_channels // self.p, out_channels=dw_channels // self.p, kernel_size=1,
        ...
        self.conv3 = nn.Conv2d(in_channels=dw_channels // self.p, out_channels=c, kernel_size=1, stride=1, padding=0,
                               groups=1, bias=True)
