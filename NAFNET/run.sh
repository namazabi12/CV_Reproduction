...
#python basicsr/train.py -opt options/train/EDSR/train_EDSR_NAF_HOAF_Mx2.yml
python basicsr/train.py -opt options/train/SwinIR/train_GAP_SwinIR_SRx2_scratch.yml
...
#python basicsr/test.py -opt options/test/EDSR/test_EDSR_NAF_HOAF_Mx2_2.yml